...
JAZZMIN_SETTINGS = {
    ...
    "order_with_respect_to": [
        ...
        "store.ConfigInventoryAsset",
        "store.ConfigAllocation",
        "store.CupFulfillmentRecipe",
        "store.CupFillerRule",
        "store.Panel",
        "store.Inbound",
    ...
    "icons": {
        ...
        "انبار کانفیگ‌ها": "fas fa-warehouse",
        ...
        "store.ConfigInventoryPool": "fas fa-boxes-stacked",
        "store.ConfigInventoryAsset": "fas fa-list-check",
        "store.ConfigAllocation": "fas fa-share-nodes",
        "store.CupFulfillmentRecipe": "fas fa-mug-hot",
        "store.CupFillerRule": "fas fa-list-ol",
