...
SECRET_KEY = 'django-insecure-hrf$n9ubs9qr&u!+%gva^ku%fg@f=ds98u*47i=(b7vjp=rdm+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['panel.vawmusic.ir', 'panel.wavmusic.ir', '194.5.195.122', '127.0.0.1']
...
PAYMENT_RECEIPT_MAX_UPLOAD_SIZE = int(os.environ.get('PAYMENT_RECEIPT_MAX_UPLOAD_SIZE', 5 * 1024 * 1024))

SMSFORWARDER_WEBHOOK_TOKEN = "81617987833f92953bfeb3b58e7fdaec6fb26c4368db5a0ab70d6017a5b44f70"
